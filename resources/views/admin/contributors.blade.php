...
<head>
    ...
    <title>GBSOLUX - Gestion des Contributeurs</title>
...
<body>
    ...
    <div class="container">
        ...
        <nav class="nav">
            ...
            <a href="{{ route('admin.contributors') }}" class="active">Contributeurs</a>
        </nav>

        <div class="export-links">
            <a href="{{ route('admin.export.contributors') }}">Exporter CSV</a>
            <a href="{{ route('admin.export.contributors.pdf') }}">Exporter PDF</a>
        </div>
                    ...
                    <tr class="{{ $contributor->is_anonymous ? 'anonymous' : '' }}">
                        ...
                        <td>
                            @if($contributor->is_anonymous)
                                <span class="anonymous-badge">Oui</span>
                            @else
                                Non
                            @endif
                        </td>
                        <td><span class="stats-badge">{{ $contributor->contributions_count }}</span></td>
                        <td><span class="stats-badge">{{ $contributor->valid_contributions_count }}</span></td>
